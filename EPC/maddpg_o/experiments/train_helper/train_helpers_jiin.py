...
def parse_args(add_extra_flags=None):
    ...
    # Checkpointing
    parser.add_argument("--save-dir", type=str, default="./result/epc_food_collect_noise1",
    ...
    parser.add_argument("--load-dir", type=str, default="./result/epc_food_collect_noise1",
